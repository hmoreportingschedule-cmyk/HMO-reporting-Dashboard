  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-slate-300 font-sans flex items-center justify-center p-4 relative overflow-hidden">
       <div className="absolute inset-0 z-0">
         <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[30rem] h-[30rem] bg-emerald-600/10 rounded-full blur-[120px]"></div>
       </div>
       
       <div className="relative z-10 max-w-lg w-full bg-[#121929]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-10 text-center shadow-[0_0_40px_rgba(16,185,129,0.1)]">
         ...
         <p className="text-slate-400 mb-8 leading-relaxed">The Weekly Risala Live Report Dashboard is currently under construction. Please check back later for updates.</p>
