...
export default function App() {
  ...
  if (currentView === "hm_task") return <HindMushawaratTaskDashboard onBack={() => setCurrentView("hub")} officeUser={risalaUser} />;
  if (currentView === "user_access") return <UserAccessDashboard onBack={() => setCurrentView("hub")} officeUser={risalaUser} />;
